    ...
    return(
       <div className="w-full h-screen flex  items-center bg-accent">
           ...
           <div className="w-[calc(100%-300px)] h-full border-[10px] border-accent rounded-2xl bg-primary">
                <Routes>
                    <Route path="/" element={<h1>order dashbord</h1>}/>
                    <Route path="/products" element={<h1>product dashbord</h1>}/>
                    <Route path="/users" element={<h1>user dashbord</h1>}/>
                    <Route path="/reviews" element={<h1>Review Dashbord</h1>}/>
                </Routes>
           </div>
       </div> 
    )
